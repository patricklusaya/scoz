...
import EredivisieStandings from "./EredivisieStandings";
import EredivisieScorers from "./EredivisieScorers";
  ...
  <ModalContext.Provider value={{ openModal }}>
    ...
    >
      <BottomTab.Screen name="Standings" options={{ headerShown: false }}>
        {(props) => <EredivisieStandings {...props}  selectedSeason={selectedSeason} />}
      </BottomTab.Screen>
