...
import PrimeiraLigaStandings from "./PrimeiraLigaStandings";
import PrimeiraLigaScorers from "./PrimeiraLigaScorers";
...
const PrimeiraLiga = () => {
  ...
  const handleYearSelect = (year) => {
    ...
    if (year.length === 7) {
      ...
      const selectedSeason = selectedYearValue.toString();
  ...
  //Layout of the Right header icon
    ...
    <ModalContext.Provider value={{ openModal }}>
      ...
      >
        <BottomTab.Screen name="Standings" options={{ headerShown: false }}>
          {(props) => (
            <PrimeiraLigaStandings {...props} selectedSeason={selectedSeason} />
          )}
        </BottomTab.Screen>
